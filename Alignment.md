...
Different multiple alignment algorithms are listed below. It is important to consider the size of your dataset when choosing which one to use.  Below is a brief overview of each algorithm. 
...
# Efficient whole genome aligner for highly divergent sequences
